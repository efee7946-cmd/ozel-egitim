...
const STRINGS = {
  tr: {
    ...
    menu_section_learn: 'Öğren ve Konuş',
    menu_section_earn: 'Yıldız Kazan, Harca',
    menu_section_parent: '👪 Ebeveyn Alanı',
  ...
  en: {
    ...
    menu_section_learn: 'Learn & Talk',
    menu_section_earn: 'Earn & Spend Stars',
    menu_section_parent: '👪 Parent Area',
