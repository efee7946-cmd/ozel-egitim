/* ============================================================================
 * aac-data.js — AAC kart şablonu
 * ----------------------------------------------------------------------------
 * Salt-okunur içerik: 10 kategori × ~12 kart, TR + EN. Veritabanı yok,
 * öğrenci başına durum yok — ekran her açılışta bu şablonu doğrudan çizer.
 *
 * Kart görseli: aac-assets/<key>.jpg (kategori kapağı: aac-assets/cat_<key>.jpg).
 * Dosya yoksa karttaki visual.value emoji'si gösterilir.
 * ========================================================================= */
...
(function (root) {
  ...
  const AACData = {
    get boards() { return getActiveBoards(); },
  };
